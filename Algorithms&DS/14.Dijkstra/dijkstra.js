class WeightedGraph {
  ...
  //    if the distance is less thant what is currently in our distances object
  //      update the distance object with the new lower distance
  //      update the previous object to containt that vertex
  //      enqueue the vertex witht the total distance from the start node
